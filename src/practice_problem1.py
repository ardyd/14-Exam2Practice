...
class Box(object):
    ...
    def append_string(self, additional_contents):
        ...
        append_amount = min(space, len(additional_contents))

        additions = ''
        for k in range(append_amount):
            additions += additional_contents[k]
        self.contents += additions

        final_word = ''
        for k in range(append_amount, len(additional_contents)):
            final_word += additional_contents[k]
